...
namespace WarehouseManager.Wpf.ViewModels
{
    public partial class CreateProductViewModel : ObservableObject
    {
        ...
        public CreateProductViewModel(IProductService productService, ICategoryService categoryService)
        {
        ...
        private async Task SaveAsync()
        {
            ...
            try
            {
                ...
                // Закрыть окно
                System.Windows.Application.Current.Windows.OfType<View.CreateProductWindow>().FirstOrDefault()?.Close();
            }
